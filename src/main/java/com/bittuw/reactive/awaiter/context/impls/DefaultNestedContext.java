...
import com.bittuw.reactive.awaiter.context.AbstractNestedContext;
 ...
 * @since 21.05.2020
 */
public final class DefaultNestedContext extends AbstractNestedContext {
     ...
     */
    public DefaultNestedContext(@NonNull Object hash,
                                @NonNull ContextOwner parent,
     ...
     * @return
     */
    public static DefaultNestedContext of(@NonNull Object hash, @NonNull ContextOwner parent,
                                          @Nullable Scheduler scheduler, @Nullable String defaultKeyPrefix,
                                          @NonNull String chainHashKeyName)
    {
        return new DefaultNestedContext(hash, parent, scheduler, defaultKeyPrefix, chainHashKeyName);
    }
}
